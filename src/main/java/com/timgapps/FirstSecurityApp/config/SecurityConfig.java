...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .logout().logoutUrl("/logout")  // url - адрес для перехода при выполнении логаута
                .logoutSuccessUrl("/auth/login");   // url - url - адрес при успешном логауте, если человек разглогинился
